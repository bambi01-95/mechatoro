...
def receive():
    ...
    l_motor_vel_pub = rospy.Publisher("/set_setpoint_left_motor", Float32MultiArray, queue_size=1)
    r_motor_vel_pub = rospy.Publisher("/set_setpoint_right_motor", Float32MultiArray, queue_size=1)
    l_motor_spd = 0
    r_motor_spd = 0
    # 受け取れる最大のデータ量
    buff = 1024 * 64
